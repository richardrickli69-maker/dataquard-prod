  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-black text-white">
      ...
      <div className="bg-slate-950 border-t border-b border-slate-800">
        <div className="max-w-4xl mx-auto px-4 py-2 md:py-6 grid grid-cols-1 md:grid-cols-3 gap-0">
          <div className="flex items-center gap-4 px-4 py-4 border-b border-slate-800 md:border-b-0 md:border-r md:border-slate-700 md:justify-center md:px-0">
          ...
          <div className="flex items-center gap-4 px-4 py-4 md:justify-center md:px-0">
            <span className="text-3xl flex-shrink-0">🔒</span>
            <div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 border-t border-indigo-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Mock-up */}
          <div className="hidden md:block bg-[#0D1B2A] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
            {/* Browser Bar */}
