      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f8f9fb; padding: 40px; border-radius: 0 0 8px 8px; border: 1px solid #e2e4ea;">
            ...
            <a href="https://dataquard.ch/dashboard" style="display: inline-block; background: #22c55e; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: bold;">
              📊 Zur Policy gehen
            </a>
            <p style="font-size: 12px; color: #999; margin-top: 24px;">Job ID: ${jobId}</p>
            <p style="color: #9ca3af; font-size: 12px; text-align: center; margin-top: 32px;">Dataquard · Reinach BL, Schweiz · <a href="https://dataquard.ch" style="color: #22c55e;">dataquard.ch</a></p>
          </div>
        </div>
      `,
    });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f8f9fb; padding: 40px; border-radius: 0 0 8px 8px; border: 1px solid #e2e4ea;">
            ...
            <a href="https://dataquard.ch/checkout" style="display: inline-block; background: #22c55e; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; font-weight: bold;">
              🚀 Jetzt starten
            </a>
            <p style="color: #9ca3af; font-size: 12px; text-align: center; margin-top: 32px;">Dataquard · Reinach BL, Schweiz · <a href="https://dataquard.ch" style="color: #22c55e;">dataquard.ch</a></p>
          </div>
        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#f8f9fb;padding:40px;border-radius:0 0 8px 8px;border:1px solid #e2e4ea;">
            ...
            <div style="text-align:center;margin:32px 0;">
              <a href="https://dataquard.ch/scanner?url=${encodeURIComponent(domain)}&utm_source=rescan&utm_medium=email"
            ...
            <p style="color:#9ca3af;font-size:12px;text-align:center;">Dataquard · Reinach BL, Schweiz · <a href="https://dataquard.ch" style="color:#22c55e;">dataquard.ch</a></p>
          </div>
        </div>
      `,
    });
