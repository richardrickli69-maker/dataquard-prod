...
export async function generateInstallationPdf(params: {
  ...
  page.drawText('Datenschutzerklaerung einbinden', { x: 80, y: y + 5, size: 12, font: bold, color: black })

  y -= 22
  const step1 = [
    '1. Melden Sie sich unter dataquard.ch/dashboard an',
    '2. Klicken Sie auf "Datenschutzerklaerung generieren"',
    '3. Dokument als PDF herunterladen und lokal speichern',
    '4. Auf Ihrer Website eine neue Seite /datenschutz erstellen',
    '5. Den generierten Text dort einf\u00fcgen und Seite veroeff\u00e9ntlichen',
  ...
  const step2 = [
    ...
    '4. Den generierten Text einf\u00fcgen und Seite veroeff\u00e9ntlichen',
  ...
  const step3 = [
    ...
    '2. Waehlen Sie React/Next.js oder Vanilla JS',
    '3. Code mit "Kopieren" in die Zwischenablage kopieren',
  ...
  page.drawText('Bei Fragen: info@dataquard.ch', {
    x: 60, y: y - 2, size: 9, font, color: green
  })
